...
/**
 * This is the item provider adapter for a {@link era.foss.erf.SpecRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecRelationItemProvider extends SpecElementWithUserDefinedAttributesItemProvider implements
    ...
    protected void addSourcePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor( ((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_SpecRelation_source_feature",
                                                                              "_UI_SpecRelation_type" ),
                                                                   ErfPackage.Literals.SPEC_RELATION__SOURCE,
                                                                   true,
                                                                   false,
                                                                   true,
                                                                   null,
    ...
    protected void addTargetPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor( ((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_SpecRelation_target_feature",
                                                                              "_UI_SpecRelation_type" ),
                                                                   ErfPackage.Literals.SPEC_RELATION__TARGET,
                                                                   true,
                                                                   false,
                                                                   true,
                                                                   null,
    ...
    public String getText( Object object ) {
        String label = ((SpecRelation)object).getID();
