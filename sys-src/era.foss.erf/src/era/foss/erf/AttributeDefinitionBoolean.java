...
/**
 * The Interface AttributeDefinitionBoolean.
 * 
 * @model
 */
public interface AttributeDefinitionBoolean extends AttributeDefinition {
    ...
    /**
     * Sets the value of the '{@link era.foss.erf.AttributeDefinitionBoolean#getDefaultValue <em>Default Value</em>}'
    ...
    /**
     * Unsets the value of the '{@link era.foss.erf.AttributeDefinitionBoolean#getDefaultValue <em>Default Value</em>}'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetDefaultValue()
     * @see #getDefaultValue()
    ...
    /**
     * Returns whether the value of the '{@link era.foss.erf.AttributeDefinitionBoolean#getDefaultValue
