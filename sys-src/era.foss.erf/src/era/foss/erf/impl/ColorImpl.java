...
public class ColorImpl extends EObjectImpl implements Color {
    ...
    public org.eclipse.swt.graphics.Color getColor() {
        ...
        if( color == null ) {
            ...
            color = new org.eclipse.swt.graphics.Color( Display.getCurrent(), this.red, this.green, this.blue );
        } else {
            if( (color.getRed() != this.red) || (color.getGreen() != this.green) || (color.getBlue() != this.blue) ) {
                color.dispose();
                color = new org.eclipse.swt.graphics.Color( Display.getCurrent(), this.red, this.green, this.blue );
            }
        }
    ...
    protected EClass eStaticClass() {
        return ErfPackage.Literals.COLOR;
    }
