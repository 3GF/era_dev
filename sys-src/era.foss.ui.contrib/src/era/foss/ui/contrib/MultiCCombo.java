...
/**
 * The CCombo class represents a selectable user interface object that combines a text field and a list and issues
...
public class MultiCCombo extends Composite {
     ...
     * @see Widget#getStyle()
     */
    public MultiCCombo( Composite parent, int style ) {
        ...
        listener = new Listener() {
            public void handleEvent( Event event ) {
                ...
                if( MultiCCombo.this == event.widget ) {
                    comboEvent( event );
                    return;
                }
        ...
        filter = new Listener() {
            public void handleEvent( Event event ) {
                ...
                if( shell == MultiCCombo.this.getShell() ) {
                    handleFocus( SWT.FocusOut );
                }
            }
        };
    ...
    void createPopup( String[] items, int[] selectionIndices ) {
        ...
        int style = getStyle();
        int listStyle = SWT.V_SCROLL | SWT.MULTI;
